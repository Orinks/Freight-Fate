...
pub static HELP_PAGES: &[(&str, &[&str])] = &[
    ...
    (
        ...
        &[
            ...
            "real clock, so a mile takes as long as it really would. Any of the three can be",
    ...
    (
        ...
        &[
            ...
            "C speaks the clock, when the delivery is due, and the one hours limit that comes first.",
            "Three keys answer one hours question each, with no other detail around it.",
            "Alt A speaks time at the wheel so far, and time since coming on duty.",
            "Alt S speaks when your 30 minute break is due, or says a break will not help.",
            "Alt D contrasts your driving allowance with the legal driving cutoff,",
    ...
    (
        ...
        &[
            ...
            "within a fourteen hour driving window after coming on duty.",
            "Driving allowance decreases only while moving. The fourteen hour window",
            "keeps running through loading, fueling, inspections, ordinary breaks,",
            "and ordinary off-duty stops. Its end is your legal driving cutoff.",
            ...
            "is due, and Alt D contrasts the two driving clocks. C reads the clock and the nearest",
            ...
            "damage, and the separate delivery deadline keeps running.",
            ...
            "When a sleep need or legal driving cutoff is closing in with no reachable stop, the game",
    ...
    (
        ...
        &[
            ...
            "Deliver before the delivery deadline for a bonus. Late or damaged cargo pays less.",
