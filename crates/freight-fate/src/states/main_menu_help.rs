...
pub static HELP_PAGES: &[(&str, &[&str])] = &[
    (
        ...
        &[
            ...
            "The owner-operator start begins with a brand-new truck of your own, and fuel,",
            "repairs, and business costs are yours. You still start at level one and climb",
            "the same career as everyone else: it changes who pays, not how far along you are.",
            ...
            "but refusals cost dispatch trust.",
    ...
    (
        ...
        &[
            ...
            "Comma repeats what was just said, from any screen that is not a text box; press it again to keep stepping back through earlier messages, and Period moves forward again.",
            "Control with Comma or Period jumps to the oldest or newest message. The bracket keys switch between all messages, general messages, and driving events. Control C copies the message you are on to the clipboard.",
            ...
            "Learn game sounds on the main menu plays any sound the road uses and says what it means. It is also on the pause menu while you drive.",
        ],
    ),
    (
        "Settings",
        &[
            "Settings are grouped into categories: Gameplay, Audio, Speech, Updates,",
            "and Problem reports, plus a row that opens the Online menu. Open a category",
            "to see its settings. Gameplay opens its own submenu of four screens:",
            "Driving assistance, Difficulty and hours of service, World and traffic,",
            "and Controls.",
            "Driving assistance holds lane keeping, every driving assist, and the",
            "prominence of the lane and edge cues. World and traffic holds the weather,",
            "traffic, and parking sources. Problem reports says where the game log is saved.",
            ...
            "Relaxed gives more time to respond, wider hazard windows, gentler damage and fatigue,",
            ...
            "Real time keeps Standard's pressure and runs the driving clock at the speed of a",
            "real clock, so a mile takes as long as it really would. It lines the spoken date",
            "and time up with your computer without moving delivery time remaining or hours",
            "of service. Any of the three can be",
            ...
            "Lane keeping, formerly Lane drift, sets how much of the lane-holding",
            "work the truck does. It lives in driving assistance settings.",
            "Full keeps the truck centered in its lane and takes your exits for you,",
            "including the destination exit, with no signal and no exit lane.",
            "Partial adds gentle drift with generous steering help.",
            "When you drift, a short beep comes from that side.",
            "Steer away from the beep; a softer chime confirms you are centered again.",
            "Off drifts like a real wheel, with rumble-strip warnings and consequences,",
            "and every exit needs its signal and its exit lane.",
            "Lane changes work in every mode: on partial or off, hold the steer",
            "across the lane line; on full, tap Left or Right.",
            ...
            "Connecting the account then turns Profile sharing on and starts backing",
            "your careers up to it, so your profile has career statistics on it.",
            "Each of those is a single item on the Online menu if you want it off.",
    ...
    (
        ...
        &[
            ...
            "roads, construction zones, or heavy traffic, then cruise resumes automatically.",
            "The keeper reads the road ahead too: it eases off early for the next turn or",
            "the next lower limit, saying so for a limit, and the corner call adds",
            "Speed keeper easing when the keeper is taking the turn.",
            ...
            "M toggles it, Page Down and Page Up tune to the next and previous station,",
            "the semicolon and apostrophe keys still work, Shift with any of those changes",
            "the radio volume, and Y reads status; the radio has its own help page with",
            "stations, hosts, and signal ranges.",
            ...
            "The curve assist takes a bend on the service brakes, never the engine brake:",
            "a corner wants a precise speed, and the jake pulls only on the tractor's drives.",
            "On a real downgrade it does raise the jake, because holding a loaded truck",
            "back on a grade is the engine brake's own job, bend or no bend.",
            "Inside a no engine brake zone, cruise and the curve assist keep the jake off",
            "for you and hold speed with the brakes, except on real downgrades.",
            "Hold H to sound the horn; release H to stop it.",
            "If a sound on the road is unfamiliar, pause and open Learn game sounds: it plays every cue on demand with what it is asking for.",
        ],
    ),
    (
        ...
        &[
            ...
            "Three keys answer one hours question each, with no other detail around it.",
            "Alt A speaks time at the wheel so far, and time on duty this shift.",
            "Alt S speaks when your 30 minute break is due, or says a break will not help.",
            "Alt D speaks what ends this shift, driving time and duty window both,",
            "and where you can legally stop before it.",
            "With enforcement off each of the three says so rather than going quiet.",
            ...
            "Four keys answer one part of that each, when you want the fact without the sentence.",
            ...
            "I turns the lane locator on and off: a soft tock once a beat, panned to where",
            "the truck sits inside its lane, running until you turn it off. It needs lane",
            "keeping on partial or off, since on full the truck holds the lane for you.",
            ...
            "Alt C repeats the last CB chatter on its own, in case something else was said over the top of it. It gives the distance as it is now rather than the one you first heard, and says so once you have passed what the CB called.",
            "Comma repeats what was just said and keeps stepping back, and Period moves forward again. Control with Comma or Period jumps to the oldest or newest message, the bracket keys switch between all messages, general messages, and driving events, and Control C copies the one you are on.",
    ...
    (
        ...
        &[
            ...
            "and the Back button reads help like F1. While driving, if the driving",
            "voice is speaking, the Back button stops it instead, the way Left or",
            "Right Control does on the keyboard.",
            ...
            "and right the clock with your full hours of service, since a pad has no room",
            "for the keyboard's three separate hours keys.",
            "Hold the right bumper for the second layer: plus A starts or stops the",
            "engine, plus B reads fuel, plus X reads the posted speed limit here and",
            "how far over you are, plus Y sets or releases the parking brake,",
            "plus D-pad up reads the next listed exit, plus D-pad down opens route-stop",
            "actions or emergency shoulder sleep when fully stopped away from route points,",
            "plus D-pad left and right lower and raise the open-road cruise target, and",
    ...
    (
        ...
        &[
            ...
            "Enforcement posts sit along the road: median crossovers, weigh station",
            "aprons, construction zone details, city units. Most are empty, and you will hear",
            "one go by several times an hour without it costing you anything. A post",
            "with somebody in it makes a sound before it can see you, so nothing can",
            "catch you that you were never told about.",
            "Whether an officer notices you is not a coin toss. Five over is seen and",
            "ignored; twenty over is certain. A crest between you and a laser blocks",
            "it, fog blinds an officer's eyes and barely touches radar, and running",
            "in a pack at the pack's speed genuinely lowers your odds of being the",
            "one picked. Officers also see things that are not speed: visible damage,",
            "no chains inside a chain control, following far too close.",
            "If a trooper does light you up: signal with X, brake to a stop on the",
            "shoulder, and sit through a license and logbook check ending in an",
            "on-the-spot ticket or a warning. Ignoring the lights is logged as",
            "evasion, which costs far more. Speeding nobody saw still adds a quieter",
            "charge at settlement.",
            "Fines are real money: a few hundred dollars for lights, and into the",
            "thousands for unsafe equipment or running an open scale. Every citation",
            "already on your record makes the next one dearer, up to double, and it",
            "stops climbing there, after your third. A fine earned inside a",
            "construction zone is doubled on top of that, and you are told that is why.",
            "Some tickets cost more than money. Fifteen or more over the limit,",
            "rolling on through a failure-to-stop warning, driving through the",
            "barrels, and a second run off the road asleep each go down as a",
            "serious violation. Two inside three years suspend your CDL for sixty",
            "days, and you cannot take a load while it runs; a third costs a",
            "hundred and twenty. Running from a stop is a major offense: a year",
            "the first time, and for life the second.",
            "CB chatter passes on what other drivers have seen. It says how sure it",
            "is, it is sometimes stale, and it never claims the road is clear.",
            "Use the status menu to review that chatter with other route guidance.",
            "At the wheel, Alt C says the last CB call again on its own.",
            "Settings, Gameplay has an enforcement presence control. It changes how",
            "much police activity you hear and nothing else: getting caught is",
            "exactly as likely at every setting, and asking for the road ahead always",
            "reports enforcement in full.",
            ...
            "They are listed separately from fines an earlier load could not cover.",
            ...
            "Right. The call ends by naming the open lane, left lane open or",
            "right lane open, so one tap that way is the whole move; either lane",
            "open means both are clear. Braking works too, but an object in the",
            "lane takes nearly a full stop before you can ease around it.",
            "Brake with no lane open means nowhere to go around: brake, and do",
            "not reach for a lane change. Swerving into traffic is worse than",
            "braking.",
            "Lane counts come from real map data and change along the corridor,",
            "from one lane your side up to several. The drive says when the road",
            "widens or narrows, and L speaks which lane you are in. Exits leave",
            "from the right lane, and camping the left lane draws CB grumbling:",
            "keep right except to pass.",
            "Construction sometimes closes a lane, but never where the road runs",
            "one lane your side: you are only ordered over when there is somewhere",
            "to go. The taper callout names the closed side; move over when told,",
            "or you plow through the barrels for truck damage, a citation, and a",
            "serious violation on your record.",
            ...
            "While rolling toward a sleep-capable stop, T plans that exact stop",
            "and names the distance, exit, and whether stopping assistance is on.",
            "T never signals or takes an optional exit: press X when you choose to leave.",
            "Use X to signal or cancel your intent, slow to forty five for",
            "the ramp, and set up the exit lane unless lane keeping is on full.",
            ...
            "Use X for the destination signal unless lane keeping is on full;",
            "on full, lane keeping takes the destination exit for you.",
            ...
            "the status screen lists the next exit when you want it.",
            "When fully stopped at a route stop, T opens its menu.",
            "Fully stopped away from route points, T opens the emergency",
            "shoulder-sleep warning instead; nearby route points always take priority.",
            "If you miss a stop, continue safely and press T to plan the next sleep-capable stop. If you are already safely stopped at the missed route point, T opens its menu.",
    ...
    (
        ...
        &[
            ...
            "While driving, Alt A reads time at the wheel so far, Alt S when the break",
            "is due, and Alt D what ends the shift. C reads the clock and the nearest",
            "limit, and the Tab status menu keeps the whole hours report in one place.",
            ...
            "a ticket and poor sleep on the shoulder. A full lot still sells",
            "diesel: the fuel island is open whatever the parking is doing.",
            "You can always find somewhere to sleep. Stopped on the open road with no",
            "stop nearby, T or the pause menu offers emergency shoulder sleep: a legal",
    ...
    (
        ...
        &[
            ...
            "It has power only while the engine is running: it falls silent",
            "when the engine shuts off and comes back when it starts.",
            "M toggles the radio. Page Down tunes to the next station and",
            "Page Up to the previous; the semicolon and apostrophe keys still work.",
            "Control with any of those jumps a whole category, like from AFN to",
            "terrestrial. Shift with any of those changes the radio volume in 10",
            "percent steps instead, on or off, and Y speaks the station, signal,",
            "volume, and streamer-safe status.",
            ...
            "The terrestrial category lists the strongest signal first, and",
            "turning the radio on starts on a station that plays clean.",
            "When a station fades out completely, the radio says so and falls",
            "back to the Roadhouse instead of going silent.",
            "Real public streams, including AFN choices, play out of the box;",
            "turning streamer-safe mode on in settings hides them, for anyone",
            "streaming or recording their drive.",
    ...
    (
        ...
        &[
            ...
            "any fines carried over from earlier loads, business operating charges, and",
            "net driver pay. Tickets you were written on the road were already paid on",
            "the spot; settlement reports them but never charges them again. Speeding",
            "nobody saw costs nothing at all.",
            ...
            "Repair your truck in the terminal garage. Damage climbs in bands: past",
            "fifty percent the engine holds power back and burns more fuel, past",
            "seventy five limp mode caps you at forty five miles per hour, and past",
            "ninety the truck is out of service: you get just enough speed to clear",
            "the lane, then road service comes to you and the wait runs hours.",
            ...
            "Dispatch trust falls the other way too, and it answers to your record",
            "and what you owe as well as your reputation. Low trust means fewer and",
            "poorer loads, load choice taken back, better equipment held back, and",
            "experience arriving at a reduced rate. Run clean and you never see it.",
            "Higher levels widen distance caps, improve low-end pay, and unlock more",
            "facility variety plus refrigerated, heavy-haul, high-value, and liquid bulk freight.",
            "Carrier certificates unlock by level when the company sponsors the",
            "training, or earlier if you pay for the course at the terminal.",
            "The real CDL letters go further: the doubles endorsement opens",
            "twin-trailer freight, tank opens liquid bulk, and hazmat adds a paid",
            "background check that clears over game days while you keep driving.",
            "Late in the career, the TWIC port card opens secure port containers",
            "and the LCV certificate opens turnpike doubles on the states that",
            "allow them. Book everything under Licenses and training at any terminal.",
    ...
    (
        ...
        &[
            ...
            "chain law out of compliance risks a citation of nearly six hundred",
            "dollars, and more with citations already on your record.",
    ...
    fn enter(&mut self, ctx: &mut GameContext) {
        ctx.say(&format!(
            "How to play. Left and Right arrows change pages. Up and Down arrows \
             ...
             stops the current speech. Escape goes back. {}",
            self.page_title()
        ));
    }
