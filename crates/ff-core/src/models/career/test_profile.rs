...
// The business gates (`business.py`), repeated for the fake's eligibility
// answers.
const OWNER_OPERATOR_LEVEL: i64 = 18;
const OWNER_OPERATOR_REPUTATION: f64 = 80.0;
const OWNER_OPERATOR_DELIVERIES: i64 = 35;
const OWNER_OPERATOR_BUY_IN: f64 = 35_000.0;
const OWNER_OPERATOR_WORKING_CAPITAL: f64 = 10_000.0;
const AUTHORITY_READY_LEVEL: i64 = 21;
const AUTHORITY_READY_DELIVERIES: i64 = 60;
const AUTHORITY_READY_REPUTATION: f64 = 90.0;
const AUTHORITY_READY_RESERVE: f64 = 12_500.0;
const AUTHORITY_READY_WORKING_CAPITAL: f64 = 25_000.0;
const AUTHORITY_ACTIVATION_DELIVERIES: i64 = 75;
const AUTHORITY_ACTIVATION_LEVEL: i64 = 25;
const AUTHORITY_ACTIVATION_REPUTATION: f64 = 92.0;
const AUTHORITY_ACTIVATION_COST: f64 = 15_000.0;
const AUTHORITY_ACTIVATION_WORKING_CAPITAL: f64 = 35_000.0;
