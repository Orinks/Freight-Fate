...
from .base import MenuItem, MenuState, State, spoken_char
...
class NameEntryState(State):
    ...
    A review cursor tracks where in the typed name the player currently is
    ...
    def lines(self) -> list[str]:
        ...
        return [
            "New career",
            "",
            f"Driver name: {marked}",
            "Left and right arrows review letters, Home and End jump to the "
            "ends. Enter to confirm, Escape to cancel, F2 to hear the whole name.",
        ]
