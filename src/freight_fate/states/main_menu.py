...
HELP_PAGES = [
    ...
    ("On the road", [
        ...
        "Tolls and approved accessorials are carrier-paid or reimbursed settlement charges.",
        "They are spoken separately from driver-responsibility costs like speeding fines.",
