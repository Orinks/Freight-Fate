...
HELP_PAGES = [
    ...
    ("On the road", [
        ...
        "The current dispatch network uses checked-in route geometry, grade data, state context,",
        "and enough curated truck-relevant POIs for each lane.",
        "Future route expansion must meet the same source-backed POI gate before dispatch uses it.",
        "Toll roads, plazas, and electronic gantries are announced as route events, not rest-stop menus.",
        "Toll charges are recorded as trip expenses and charged through company transponder settlement.",
        "Service plazas on toll roads still behave as separate POIs when their services support fuel, food, breaks, or saves.",
    ...
    ("Deliveries and money", [
        ...
        "Delivery settlement reports gross pay, toll expenses, and net settlement.",
    ...
    ("Markets and route coverage", [
        ...
        "New dispatches still use only route corridors with curated stop coverage.",
