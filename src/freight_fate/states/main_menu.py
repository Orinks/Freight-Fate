...
HELP_PAGES = [
    ...
    ("On the road", [
        ...
        "Route geometry, grade data, and state context are checked in broadly,",
        "but dispatch only uses corridors whose truck stops are curated enough for the lane.",
        "Placeholder POIs are data gaps, not playable rest-stop promises.",
