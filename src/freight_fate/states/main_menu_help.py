...
HELP_PAGES = [
    ...
    ("Driving basics", [
        ...
        "M toggles it, brackets tune receivable stations, and Y reads station,",
        "signal, volume, and streamer-safe status.",
    ...
    ("On the road", [
        ...
        "at settlement.",
        "CB radio chatter can warn about patrols before you reach them.",
        "Use the status menu to check upcoming patrols.",
        ...
        "Press X to signal for the exit. With lane drift off, X also sets",
        "the exit lane; with lane drift on, steer right when prompted.",
