...
HELP_PAGES = [
    ...
    (
        ...
        [
            ...
            "Nearby public stations join that same dial quietly in the background",
            "when real streams are on and streamer-safe mode is off.",
            "The default search uses your approximate real-world location.",
            "If that lookup fails, it follows the simulated truck instead.",
            "Control with a bracket jumps a whole category.",
            ...
            "Real public streams stay hidden unless you enable real streams and",
            "turn streamer-safe mode off in settings. If a selected stream cannot",
            "play, the radio says so and falls back safely.",
        ],
    ),
    (
