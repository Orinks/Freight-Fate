...
HELP_PAGES = [
    ...
    (
        "Settings",
        [
            "Settings are grouped into categories: Gameplay, Driving assistance, Audio,",
            "Speech and weather, Updates, and Problem reports, plus a row that opens the",
            "Online menu. Open a category to see its settings.",
            "Driving assistance holds lane keeping, every driving assist, and the loudness",
            "of the lane and edge cues. Problem reports says where the game log is saved.",
