...
HELP_PAGES = [
    ...
    (
        ...
        [
            ...
            "Stations with coordinates are distance-filtered and called nearby.",
            "State-matched stations without coordinates are called internet-only,",
            "stay receivable on the active dial, and make no distance or signal claim.",
            ...
            "If a selected stream cannot play, the radio says so and falls back safely.",
        ],
    ),
    (
