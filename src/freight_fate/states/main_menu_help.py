...
HELP_PAGES = [
    ...
    (
        ...
        [
            ...
            "Online sharing can put your hauls on the drivers board at orinks.net,",
            "showing a driver name you choose, your route, cargo, and rough progress.",
            "With renewed website consent it also publishes factual delivery journal",
            "entries, achievements, career totals, current truck, and last-saved city.",
            "Public profiles can appear in updates; unlisted profiles require their link;",
