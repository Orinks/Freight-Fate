...
HELP_PAGES = [
    ...
    (
        ...
        [
            ...
            "If you miss a stop, continue safely and press T to plan the next "
            "sleep-capable stop. If you are already safely stopped at the missed "
            "route point, T opens its menu.",
