...
HELP_PAGES = [
    ...
    (
        ...
        [
            ...
            "If you pause or leave the game sitting for half an hour, the presence",
            "comes down until you play again, so it never says you are mid-run",
    ...
    (
        ...
        [
            ...
            "Dispatch loops you back to the approach so you can press X on the next call.",
