...
class DrivingControlsMixin:
    ...
    def _speak_keyboard_help(self) -> None:
        ...
        self.ctx.say(
            ...
            "T plans the next nearby sleep-capable stop while rolling, then X "
            "signals for its exit. When already stopped at a route stop, T opens "
            "its menu: available actions may include fuel, break, sleep, "
            "inspect, roadside assistance, or save when source-backed. Fully "
            "stopped away from route points, T opens the emergency shoulder-sleep "
