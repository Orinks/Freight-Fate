...
class Trip(TripRoadEventMixin, TripTrafficMixin, EnforcementPostMixin):
    ...
    def _zone_warning_message(self, zone: Zone, ahead: float) -> str:
        if zone.reason == "construction":
            ...
            # Telling a driver to brake now for something eight miles away
            # is untrue, and they act on it: Shane asked why the game slows
            # "as early as we are" for construction when the assists in fact
            # ease at the taper, and he had been braking because he was told
            # to (2026-08-24). It also spends the phrase that has to mean
            ...
            return (
                f"In {self._ahead_text(ahead)}, construction ahead. "
