...
| A career changed outside the game whose backup waits until it is checked by hand | "<career>: backup waiting for review"; after a no, "<career>: backup declined after review" | held, quarantined, pending approval, blocked | `cloud_saves::rejection_status` |
