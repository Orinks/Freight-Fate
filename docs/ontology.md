...
| The bend at the end of the deceleration lane that the exit speed is for ("Ramp curve, too fast, drifting to the outside.") | ramp curve | ramp bend, loop, the curve (unqualified, on a ramp) | `DrivingState::ramp_curve_radius_ft`, `ExitRampLayout::curve_mi` |
