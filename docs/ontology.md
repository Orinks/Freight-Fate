...
| A signal OSM maps at an intersection on a facility's streets, played by the ramp terminal's rules | traffic light ("Traffic light ahead. Light red.") | signal, stoplight, street light, ramp light | `driving_events/street_controls.rs`, `street_control_kind == "signal"` |
