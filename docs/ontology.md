...
| Music the game composes itself, plus the restored 1.5 tracks and hand-made modules; what Music source: Synthesized plays in menus and on the Roadhouse | synthesized music | no-AI music, generated music, procedural music | `Settings.synth_music`, `ff_core::music_synth` |
